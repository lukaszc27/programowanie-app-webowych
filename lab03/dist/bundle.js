...
var Application = /** @class */ (function () {
    ...
    Application.prototype.render = function () {
        var mainContainer = document.getElementById('widgets');
        if (mainContainer != null) {
            ...
            elements.forEach(function (el) {
                ...
                var imgSource = "http://openweathermap.org/img/wn/" + el.weather[0].icon + "@2x.png";
